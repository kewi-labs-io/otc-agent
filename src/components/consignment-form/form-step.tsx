      ...
      <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">Allow buyers to negotiate within ranges</p>
          </div>
        </div>
        <button
          type="button"
      ...
      {showAdvanced && (
        <div className="space-y-4 pl-2 border-l-2 border-zinc-200 dark:border-zinc-700">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/30">
            ...
            <button
              type="button"
              onClick={() => updateFormData({ isFractionalized: !formData.isFractionalized })}
              className={`relative w-11 h-6 rounded-full transition-colors ${
                formData.isFractionalized ? "bg-orange-500" : "bg-zinc-300 dark:bg-zinc-600"
              }`}
            >
              <span
                className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${
                  formData.isFractionalized ? "translate-x-5" : "translate-x-0"
                }`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Private Listing</p>
            ...
            <button
              ...
              className={`relative w-11 h-6 rounded-full transition-colors ${
                formData.isPrivate ? "bg-orange-500" : "bg-zinc-300 dark:bg-zinc-600"
              }`}
            >
              <span
                className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${
          ...
          <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/30 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Execution Window</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData({ maxPriceVolatilityBps: Number(e.target.value) * 100 })
                    }
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData({ maxTimeToExecuteSeconds: Number(e.target.value) * 60 })
                    }
                    className="w-full px-3 py-2 text-sm rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800"
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-zinc-500">
