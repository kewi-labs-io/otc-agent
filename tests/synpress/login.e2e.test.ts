...
import { connectMetaMaskWallet, connectPhantomWallet, waitForAppReady, disconnectWallet } from "./utils/login";
import { evmSeller, phantomTrader } from "./utils/wallets";
import { BASE_URL, assertServerHealthy, sleep } from "../test-utils";
...
metamaskTest.describe("MetaMask Login", () => {
  ...
  metamaskTest("connects MetaMask wallet successfully", async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  metamaskTest("wallet persists across page navigation", async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  metamaskTest("can disconnect and reconnect", async ({
    context,
    page,
    metamaskPage,
    extensionId,
...
phantomTest.describe("Phantom Login", () => {
  ...
  phantomTest("connects Phantom wallet successfully", async ({
    context,
    page,
    phantomPage,
    extensionId,
  ...
  phantomTest("wallet persists across page navigation", async ({
    context,
    page,
    phantomPage,
    extensionId,
